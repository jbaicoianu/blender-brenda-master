...
angular.module('grafana.directives')
	.service('$upload', ['$http', '$q', '$timeout', function($http, $q, $timeout) {
...
angular.module('grafana.directives')
	.directive('ngFileDropAvailable', [ '$parse', '$timeout', function($parse, $timeout) {
	return function(scope, elem, attr) {
...
angular.module('grafana.directives')
	.directive('ngFileDrop', [ '$parse', '$timeout', '$location', function($parse, $timeout, $location) {
	return function(scope, elem, attr) {
		if ('draggable' in document.createElement('span')) {
